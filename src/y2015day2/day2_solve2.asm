...
calculate:   
    ...
    ; now the r8,r9,r12 will hold in asec order
    ...
    ; calculates the parameters of the smallest face and storing on r12, we don't need r12 anymore
    mov r12, r8
    add r12, r9
    add r12, r12

    ; add thre result to r13
    add r13, r12
    add r13, r11
